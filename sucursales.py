...
def eliminar_sucursal():
    ...
    params = (id_sucursal,) # La coma después de id_sucursal asegura que params sea interpretado como una tupla, incluso si solo contiene un elemento. Sin esta coma, Python interpretaría (id_sucursal) como una expresión entre paréntesis, no como una tupla.
    execute_query(query, params)
